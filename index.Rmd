...
author:  |
  ...
  <span class="" style="font-size:75%">https://m-clark.github.io/workshops</span><br><br>
...
output:
  bookdown::gitbook:
    css: [css/book.css, css/standard_html.css, 'https://use.fontawesome.com/releases/v5.0.13/css/all.css']
    highlight: pygments
...
nocite: | 
  @rstudio2018, @knuth1992literate, @xie2018
---
